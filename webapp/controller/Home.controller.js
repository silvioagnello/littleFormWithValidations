sap.ui.define([
    ...
    return Controller.extend("Project1.webapp.controller.Home", {

        onInit: function () {
            var oView = this.getView(),
                oMM = Core.getMessageManager();

            oView.setModel(new JSONModel({ name: "", email: "", pasword: "" }));
            ...
            oMM.registerObject(oView.byId("checkpasswordInput"), true);
        },
        ...
        _validateInput: function (oInput) {
            ...
            if (bValidationError == false && oID == "/confPassword") {
                var val_pass = this.byId("passwordInput")._lastValue;
                var val_conf = this.byId("checkpasswordInput")._lastValue;
                if (val_pass != val_conf) {
                    bValidationError = true;
                }
            }
